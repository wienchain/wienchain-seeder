...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Wienchain-seeder\n"
...
static const string mainnet_seeds[] = {"116.62.234.16", "3.127.21.66", "3.84.100.219", "13.250.60.98", "52.15.231.151", ""};
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("116.62.234.16", 8888), true);
    db.Add(CService("3.127.21.66", 8888), true);
    db.Add(CService("3.84.100.219", 8888), true);
    db.Add(CService("13.250.60.98", 8888), true);
    db.Add(CService("52.15.231.151", 8888), true);
  }
  do {
